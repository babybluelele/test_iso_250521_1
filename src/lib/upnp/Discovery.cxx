...
void
UPnPDeviceDirectory::Downloader::OnDataStartPos(size_t size)
{

}

void
UPnPDeviceDirectory::Downloader::OnDataSize(size_t size)
{

}

void
UPnPDeviceDirectory::Downloader::OnDataSizetotal(size_t size)
{
