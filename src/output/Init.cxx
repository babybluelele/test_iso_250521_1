			   ...
			   const AudioOutputDefaults &defaults)
{
	...
	if (mixer_type == MixerType::SOFTWARE)
	{
		FormatNotice(output_domain, "softwareVolumeStatus on from mpdcfg");
		mpd_softwareVolumeStatus_set(true);
	}
	else
	{
		FormatNotice(output_domain, "softwareVolumeStatus off from mpdcfg");
